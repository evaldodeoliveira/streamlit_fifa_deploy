...
#Estes dados serão compartilhados entre as demais páginas e para isto iremos tratá-los via state

#Testando se os dados já foram carregados anteriormente
if "data" not in st.session_state:
    df_data = pd.read_csv("datasets/CLEAN_FIFA23_official_data.csv", index_col=0)
    #aplicando filtros nos dados como: filtrar somente jogadores com contratos válidos
